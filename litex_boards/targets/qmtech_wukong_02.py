...
from litex_boards.platforms import qmtech_wukong_02
...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=int(100e6), with_ethernet=False, with_etherbone=False,
        ...
        platform = qmtech_wukong_02.Platform()

        # SoCCore ----------------------------------------------------------------------------------
        SoCCore.__init__(self, platform, sys_clk_freq,
            ident          = "LiteX SoC on QMTECH Wukong Board (Rev 02)",
            ident_version  = True,
            **kwargs)
...
def main():
    ...
    if args.with_spi_sdcard:
        soc.platform.add_extension(qmtech_wukong_02._sdcard_pmod_io)
        soc.add_spi_sdcard()
    if args.with_sdcard:
        soc.platform.add_extension(qmtech_wukong_02._sdcard_pmod_io)
        soc.add_sdcard()
